...
CAL_OBJ_MM_L2R = 5700     # L2R Moving Objects, Length of the calibration object in millimetres
...
PLUGIN_NAME = "picam480"  # Specify filename in plugins subfolder without .py extension per below
...
# Camera Settings
# ---------------
CAMERA = "pilegcam"    # valid values usbcam, rtspcam, pilibcam, pilegcam
CAM_LOCATION = "Front Window"
USBCAM_SRC = 7         # Device number of USB connection usually 0, 1, 2, Etc
...
GUI_IMAGE_WIN_ON = False   # True=Show the camera on a gui windows. False=Don't Show (useful for image_sign)
